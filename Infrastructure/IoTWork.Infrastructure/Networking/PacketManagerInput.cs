...
namespace IoTWork.Infrastructure.Networking
{
    public class PacketManagerInput: IPacketManagerInput
    {
        ...
        IFormatter<IotPacket> _packetFormatter;
        IFormatter<Payload> _payloadFormatter;
        ISigner<IotPacket> _packetSigner;
        ...
        public IIotPacket Decode(byte[] buffer)
        {
            ...
            _packetFormatter = IoTWorkHelper.AllocateFormatter<IotPacket>(_packetFormatterCode);
            _payloadFormatter = IoTWorkHelper.AllocateFormatter<Payload>(_payloadFormatterCode);
            _packetSigner = IoTWorkHelper.AllocateSigner<IotPacket>(_packetSignerCode);
        ...
        public IFormatter<IotPacket> SetPacketFormatter()
        {
        ...
        public ISigner<IotPacket> SetPacketSigner()
        {
